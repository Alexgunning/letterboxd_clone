...
exports.request = exports.rawRequest = exports.GraphQLClient = void 0;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cross_fetch_1.default(this.url, __assign({ method: 'POST', headers: __assign({ 'Content-Type': 'application/json' }, headers), body: body }, others))];
                    case 1:
                        response = _b.sent();
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (response.ok && !result.errors && result.data) {
                            ...
                            errorResult = typeof result === 'string' ? { error: result } : result;
                            throw new types_1.ClientError(__assign(__assign({}, errorResult), { status: response.status }), { query: query, variables: variables });
                        }
                        return [2 /*return*/];
                }
            });
