...
export function render(opts, logRecord) {
    var _a, _b, _c;
     ...
     */
    const path = (_c = (_b = logRecord.path) === null || _b === void 0 ? void 0 : _b.join(renderEl(separators.path))) !== null && _c !== void 0 ? _c : '';
    ...
    const availableSinglelineContextColumns = terminalWidth - gutterWidth - preContextWidth - separators.context.singleLine.symbol.length;
        ...
        if (contextFitsSingleLine) {
            ...
            contextRendered =
                renderEl(separators.context.multiline) +
                    ...
                    spineRendered +
                    contextEntriesRendered
                        .map(([key, value]) => `${chalk.gray(utils.clampSpace(widestKey, key))}${renderEl(separators.contextKeyVal.multiline)}${formatBlock(value, {
