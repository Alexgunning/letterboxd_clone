...
exports.traceFiles = exports.bundle = void 0;
const tslib_1 = require("tslib");
const node_file_trace_1 = tslib_1.__importDefault(require("@zeit/node-file-trace"));
const fs = tslib_1.__importStar(require("fs"));
const fsJetpack = tslib_1.__importStar(require("fs-jetpack"));
const Path = tslib_1.__importStar(require("path"));
const nexus_logger_1 = require("../nexus-logger");
const process_1 = require("../process");
const log = nexus_logger_1.rootLogger.child('cli').child('build').child('bundle');
/**
...
async function bundle(opts) {
    ...
    await writeToFS(Object.assign({ files }, opts));
    log.trace('done bundling');
}
exports.bundle = bundle;
async function traceFiles(opts) {
    const sourceCache = new Map();
    const worktimeTesttimePluginPaths = getWorktimeAndTesttimePluginPaths(opts.base, opts.plugins);
    const { fileList, reasons } = await node_file_trace_1.default([opts.entrypoint], {
        ts: true,
        mixedModules: true,
        base: opts.base,
        /**
 ...
 */
function getWorktimeAndTesttimePluginPaths(base, plugins) {
    const paths = [];
