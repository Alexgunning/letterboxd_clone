...
const nodecp = tslib_1.__importStar(require("child_process"));
const nexus_logger_1 = require("../nexus-logger");
const TTYLinker = tslib_1.__importStar(require("../tty-linker"));
const log = nexus_logger_1.rootLogger.child('dev').child('link');
class Link {
    constructor(options) {
