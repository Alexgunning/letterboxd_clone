 ...
 */
export function extractContextTypes(program) {
...
function extractTypeImportInfoFromType(t) {
    ...
    if (!d)
        throw exception('A type with a symbol but the symbol has no declaration', {});
...
export function mergeUnionTypes(unionTypes) {
