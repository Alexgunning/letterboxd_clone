...
export function create(appState) {
    ...
    const api = {
        ...
        handlers: {
            get playground() {
                var _a;
                return ((_a = assembledGuard(appState, 'app.server.handlers.playground', () => {
                    // todo should be accessing settings from assembled app state settings
                    return wrapHandlerWithErrorHandling(createRequestHandlerPlayground({ graphqlEndpoint: settings.data.path }));
                })) !== null && _a !== void 0 ? _a : noop);
            },
            get graphql() {
                var _a;
                return ((_a = assembledGuard(appState, 'app.server.handlers.graphql', () => {
                    return wrapHandlerWithErrorHandling(createRequestHandlerGraphQL(appState.assembled.schema, appState.assembled.createContext));
                })) !== null && _a !== void 0 ? _a : noop);
            },
        },
    };
        ...
        private: {
            ...
            assemble(loadedRuntimePlugins, schema) {
                ...
                if (settings.data.playground) {
                    express.get(settings.data.playground.path, wrapHandlerWithErrorHandling(createRequestHandlerPlayground({ graphqlEndpoint: settings.data.path })));
                }
