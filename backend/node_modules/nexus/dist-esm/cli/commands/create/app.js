 ...
 * TODO
 */
export async function run(configInput) {
 ...
 * TODO
 */
export async function runBootstrapper(configInput) {
    var _a;
    log.trace('start bootstrapper');
    await assertIsCleanSlate();
    const projectName = (_a = configInput === null || configInput === void 0 ? void 0 : configInput.projectName) !== null && _a !== void 0 ? _a : CWDProjectNameOrGenerate();
...
async function getNexusVersion() {
    ...
    const nexusVersion = nexusVersionEnvVar !== null && nexusVersionEnvVar !== void 0 ? nexusVersionEnvVar : `${ownPackage.version}`;
    return nexusVersion;
}
...
async function scaffoldBaseFiles(options) {
    ...
    `),
      ...
      `),
        ...
        fs.writeAsync('tsconfig.json', tsconfigTemplate({
            sourceRootRelative,
            outRootRelative: Layout.DEFAULT_BUILD_DIR_PATH_RELATIVE_TO_PROJECT_ROOT,
        })),
        fs.writeAsync('.vscode/launch.json', stripIndent `
        {
